...
3.  For convenience, we want to update the modalities of the `dteloc` variable : `1` means it's a house and `2` it's a flat. You can check pandas's Categorical function on [their documentation](https://pandas.pydata.org/docs/reference/api/pandas.Categorical.html#pandas.Categorical).
...
# 3 - How do you prepare your data with scikit-learn?
...
2.  Create the Pipeline for training a RandomForestRegressor model. Go to the [scikit-learn's documentation](https://scikit-learn.org/stable/modules/compose.html#) on the matter to understand how it works. 
...
rf_pipeline = Pipeline([
    ...
    ('random_forests', RandomForestRegressor(**rf_params))
])
